...
router.post('/', validateApiKey, validateRequest(createRefundSchema), createRefund);
...
router.put('/:id/status', validateApiKey, validateObjectId('id'), validateRequest(updateRefundStatusSchema), updateRefundStatus);
